# Zimbabwe Procedure - Zimbabwe Clinical IG v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-procedure | *Version*:0.1.0 |
| Draft as of 2026-06-16 | *Computable Name*:ZimProcedure |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/zw.fhir.ig.clinical|current/StructureDefinition/StructureDefinition-zw-procedure.json)
...
```json
{
  ...
  "id" : "zw-procedure",
  "url" : "http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-procedure",
  "version" : "0.1.0",
  "name" : "ZimProcedure",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-condition"]
      }],
      "mustSupport" : true
    }]
  }
