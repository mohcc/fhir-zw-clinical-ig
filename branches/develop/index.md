# Home - Zimbabwe Clinical IG v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/clinical/ImplementationGuide/zw.fhir.ig.clinical | *Version*:0.1.0 |
| Draft as of 2026-06-16 | *Computable Name*:ZWClinical |
...
* Creating an issue on GitHub [clinical repository](https://github.com/WorldHealthOrganization/clinical)
...
This is an R4 IG. None of the features it uses are changed in R4B, so it can be used as is with R4B systems. Packages for both [R4 (zw.fhir.ig.clinical.r4)](package.r4.tgz) and [R4B (zw.fhir.ig.clinical.r4b)](package.r4b.tgz) are available.
...
* [Condition Category Codes](http://terminology.hl7.org/7.2.0/CodeSystem-condition-category.html): [Condition/condition1](Condition-condition1.md)
* [Condition Clinical Status Codes](http://terminology.hl7.org/7.2.0/CodeSystem-condition-clinical.html): [Condition/condition1](Condition-condition1.md)
* [ConditionVerificationStatus](http://terminology.hl7.org/7.2.0/CodeSystem-condition-ver-status.html): [Condition/condition1](Condition-condition1.md)
* [Observation Category Codes](http://terminology.hl7.org/7.2.0/CodeSystem-observation-category.html): [Observation/observation1](Observation-observation1.md)
...
```json
{
  ...
  "id" : "zw.fhir.ig.clinical",
  "url" : "http://mohcc.gov.zw/fhir/clinical/ImplementationGuide/zw.fhir.ig.clinical",
  "version" : "0.1.0",
  "name" : "ZWClinical",
  "title" : "Zimbabwe Clinical IG",
  "status" : "draft",
  "experimental" : false,
  "date" : "2026-06-16T07:37:12+00:00",
  ...
  "description" : "Zimbabwe Clinical FHIR Implementation Guide covering conditions, observations and procedures",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://mohcc.gov.zw/fhir/clinical/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-condition"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-procedure"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
