# Zimbabwe Condition - Zimbabwe Clinical IG v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-condition | *Version*:0.1.0 |
| Draft as of 2026-06-16 | *Computable Name*:ZimCondition |
...
* Refer to this Profile: [Zimbabwe Procedure](StructureDefinition-zw-procedure.md)
* Examples for this Profile: [Condition/condition1](Condition-condition1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/zw.fhir.ig.clinical|current/StructureDefinition/StructureDefinition-zw-condition.json)
...
```json
{
  ...
  "id" : "zw-condition",
  "url" : "http://mohcc.gov.zw/fhir/clinical/StructureDefinition/zw-condition",
  "version" : "0.1.0",
  "name" : "ZimCondition",
